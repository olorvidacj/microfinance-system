    ...
    <div className="space-y-6 pb-12 animate-in fade-in duration-150">
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        <div>
          <div className="flex items-center gap-2">
            ...
            <span className="px-2.5 py-0.5 rounded-full text-xs font-semibold bg-gold-500/20 text-gold-700 border border-gold-400/30">
        ...
        <div className="flex items-center gap-2.5 w-full sm:w-auto">
          {canRegister && (
            <button
              ...
              className="w-full sm:w-auto px-4 py-2.5 bg-navy-900 hover:bg-navy-800 text-white rounded-xl font-bold transition flex items-center justify-center gap-2 text-xs shadow-md shadow-gold-500/20"
            >
      ...
      <div className="p-3.5 bg-slate-900 text-white rounded-2xl flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 shadow-sm">
        <div className="flex items-center gap-3">
          <div className="w-8 h-8 rounded-xl bg-white/10 border border-white/20 flex items-center justify-center text-gold-300 font-bold">
            <Lock className="w-4 h-4" />
          </div>
          <div>
            <div className="flex items-center gap-2">
              <span className="font-bold text-xs">Security & RBAC Enforcement:</span>
              <span className="px-2 py-0.5 rounded-md bg-gold-500/30 text-slate-300 text-[10px] font-mono font-bold border border-gold-400/30">
      ...
      <div className="flex border-b border-slate-200 gap-2 overflow-x-auto text-xs">
        ...
        >
          ...
          <span className="px-2 py-0.5 rounded-full text-[10px] bg-gold-500/10 text-gold-700">
          ...
          <div className="bg-white p-4 rounded-2xl border border-slate-200 shadow-xs flex flex-col md:flex-row gap-3 items-stretch md:items-center justify-between text-xs">
            <div className="relative flex-1">
              ...
              <input
                ...
                className="w-full pl-9 pr-4 py-2 bg-slate-50 border border-slate-200 rounded-xl focus:ring-2 focus:ring-gold-500 focus:bg-white text-slate-900 transition"
              />
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              {displayedClients.map((client) => {
                ...
                return (
                  <div
                    key={client.id}
                    className="bg-white border border-slate-200 hover:border-gold-400 rounded-2xl p-4 shadow-xs hover:shadow-md transition flex flex-col justify-between space-y-3 group"
                  >
                    {/* Header Strip */}
                    <div className="flex items-start justify-between gap-3">
                      <div className="flex items-center gap-3">
                        ...
                        />
                        <div>
                          <h3 className="font-bold text-slate-900 text-sm group-hover:text-gold-600 transition">
                            {client.fullName}
                          </h3>
                    ...
                    <div className="pt-2 border-t border-slate-100 flex items-center justify-between gap-2">
                      ...
                      <div className="flex items-center gap-1.5">
                        <button
                          ...
                          className="px-3 py-1.5 bg-gold-500/10 text-gold-700 hover:bg-gold-500/20 rounded-lg font-semibold text-xs transition flex items-center gap-1"
                        >
                  ...
                  <div className="flex flex-wrap items-center gap-2 self-end md:self-center">
                    ...
                    {canReviewKyc && (
                      <button
                        ...
                        className="px-4 py-1.5 bg-navy-900 hover:bg-navy-800 text-white rounded-xl font-bold text-xs transition flex items-center gap-1.5 shadow-xs"
                      >
                        <ShieldCheck className="w-3.5 h-3.5" />
                        Execute KYC Review
                      </button>
            ...
            {[
              ...
              return (
                <div key={s.step} className="p-3 bg-white border border-slate-200 rounded-xl space-y-1">
                  <span className="text-[10px] uppercase font-bold text-gold-600">{s.title}</span>
              ...
              >
                <div>
                  <div className="flex items-center gap-2">
                    ...
                    <span className="font-mono text-[11px] text-gold-700 bg-gold-500/10 px-2 py-0.5 rounded font-bold">
                ...
                <div className="flex items-center gap-2">
                  {app.currentStep === 'SUBMITTED' && (
                    <button
                      ...
                      className="px-3 py-1.5 bg-navy-900 hover:bg-navy-800 text-white rounded-lg font-bold text-xs transition"
                    >
                      Verify & Log PMES
                    </button>
                  )}
                      ...
                      <div className="flex items-start gap-2.5">
                        ...
                        <div>
                          <div className="flex items-center gap-2">
                            ...
                            <span className="font-semibold text-gold-700">• {log.fromStatus} → {log.toStatus}</span>
                          </div>
                  ...
                  {[
                    ...
                    <button
                      ...
                      className={`p-2 rounded-xl border text-center font-bold transition ${
                        quickDecision === d.id ? `${d.color} ring-2 ring-gold-500/20` : 'border-slate-200 text-slate-600'
                      }`}
                    >
                      {d.label}
                    </button>
