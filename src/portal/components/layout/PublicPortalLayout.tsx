...
export const PublicPortalLayout: React.FC<{ children?: React.ReactNode }> = ({ children }) => (
  <div className="grid min-h-screen bg-slate-50 font-sans text-slate-800 antialiased lg:grid-cols-2">
    {/* Left brand panel */}
    <div className="relative hidden overflow-hidden bg-gradient-to-br from-emerald-700 via-emerald-800 to-teal-900 lg:flex lg:flex-col lg:justify-between lg:p-12">
      ...
      <div className="relative flex items-center gap-3">
        ...
        <div>
          ...
          <span className="text-[11px] uppercase tracking-widest text-emerald-200">Microfinance Cooperative</span>
        </div>
      </div>

      <div className="relative">
        <h1 className="max-w-md text-4xl font-bold leading-tight text-white">
          Your cooperative, <span className="text-emerald-300">in your pocket.</span>
        </h1>
      ...
      <p className="relative text-xs text-emerald-100/60">© {new Date().getFullYear()} HOSCOMO Microfinance Cooperative. All rights reserved.</p>
    </div>
    ...
    <div className="flex items-center justify-center px-4 py-10 sm:px-8">
      <div className="w-full max-w-md">
        <div className="mb-8 flex items-center gap-3 lg:hidden">
          <div className="flex h-11 w-11 items-center justify-center rounded-xl bg-gradient-to-tr from-emerald-600 to-teal-500 text-white shadow-md">
